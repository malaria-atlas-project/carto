...
public class SystemUtil {
	public static void addVectorBranding(String anoName, String foreGround) throws IOException, InterruptedException {
		...
		String command = "pdftk /home/will/map1_public/maps/" + foreGround + ".pdf background /tmp/tmp_mapsurface.pdf output /home/will/maps/vector/pdf/%s.pdf";
	...
	public static void addBranding(String fileName, String parasite, String foreGround) throws IOException, InterruptedException {
		Process process;
		fileName = fileName.replace(" ", "_");
		
		String command = "pdftk /home/will/map1_public/maps/" + foreGround + ".pdf background /tmp/tmp_mapsurface.pdf output /home/will/maps/pdf/%s_%s.pdf";
